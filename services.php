...
<section class="registration-section">
    <div class="registration-grid">
        <?php foreach($forms as $form): ?>
            <?php
            // Extract the actual form name by removing timestamp prefix
            $nameParts = explode('_', $form['displayName'], 2);
            $displayName = isset($nameParts[1]) ? $nameParts[1] : $nameParts[0];
                ...
                <div class="file-details mt-3">
                    <div class="file-meta mb-3">
                        <span class="text-muted">
                            <i class="fa fa-calendar me-2"></i><?php echo date('F j, Y', $form['date']); ?>
                        </span>
                    </div>
                    <a href="<?php echo htmlspecialchars($form['path']); ?>" 
        ...
        <div class="registration-container">
            <div class="text-center">
                <h2 class="registration-title">No Forms Available</h2>
        ...
        <div class="footer-content">
            <div class="footer-section">
                ...
                <ul class="footer-links">
                  ...
                  <li><a href="services.php#registration">Downloadable Forms</a></li>
                </ul>
            </div>
            <div class="footer-section">
                <h3>Contact Us</h3>
