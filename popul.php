...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($school_year) && preg_match('/^\d{4}-\d{4}$/', $school_year)) {
        try {
            ...
            header("Location: popul.php?school_year=" . urlencode($school_year));
            exit;
...
<body>
        ...
        <div class="form-section">
            ...
            <form method="POST" class="mt-4" onsubmit="return validateForm()">
                ...
                <div class="text-end mt-4">
                    <a href="admin.php?school_year=<?php echo urlencode($selectedYear); ?>" class="btn btn-secondary me-2">
    ...
    function confirmDelete(id) {
        if (confirm('Are you sure you want to delete this record?')) {
            window.location.href = 'delete_population.php?id=' + id + '&success=deleted';
        }
    }
    </script>
</body>
