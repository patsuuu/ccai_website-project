...
<main>
    <div class="container mt-5">
        <div class="row mb-4">
            <div class="col-md-6">
                <?php
                // Get unique school years from database
                $yearQuery = $pdo->query("SELECT DISTINCT school_year FROM student_population ORDER BY school_year DESC");
                $schoolYears = $yearQuery->fetchAll(PDO::FETCH_COLUMN);
                
                // If no years in database, add current year
                if (empty($schoolYears)) {
                    $currentYear = date('Y');
                    $schoolYears = array($currentYear . '-' . ($currentYear + 1));
                }
                ?>
                <form class="d-flex">
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0">Total Student Population: <?php echo $grandTotal; ?></h3>
            </div>
            <div class="card-body">
                <div class="row">
        ...
        <!-- JHS Summary -->
        <div class="card shadow mb-4">
            <div class="card-header" style="background: #000080; color: white;">
                <h3 class="mb-0">Junior High School Population</h3>
            </div>
            <div class="card-body">
                <div class="table-responsive mb-4">
                    <table class="table table-hover">
                        ...
                        <tfoot class="table-primary">
                            <tr>
                                <td colspan="2"><strong>JHS Total</strong></td>
                                <td><?php echo $jhsTotals['total_male']; ?></td>
                                <td><?php echo $jhsTotals['total_female']; ?></td>
                                <td><?php echo $jhsTotals['total']; ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
                
                <!-- Update the JHS Chart data -->
                <script>
                    // Update chart data to match new section totals
                    const jhsData = {
                    ...
                    new Chart(document.getElementById('jhsChart').getContext('2d'), {
                        type: 'bar',
                        data: jhsData,
                        options: {
                            responsive: true,
                            ...
                            plugins: {
                                title: {
                                    display: true,
                                    text: 'JHS Population by Grade Level and Gender'
                                }
                            },
                            animation: {
        ...
        <div class="card shadow mb-4">
            <div class="card-header" style="background: #000080; color: white;">
                <h3 class="mb-0">Senior High School Population</h3>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <!-- Grade 11 -->
                    <div class="col-md-6">
                        <h4 class="mb-3">Grade 11</h4>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php 
                                    $shs11Data = array_filter($shsData, function($row) {
                                        return $row['grade_level'] === 'Grade 11';
                                    });
                                    foreach ($shs11Data as $row): 
                                    ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($row['strand'] . ' - ' . $row['section']); ?></td>
                                            <td><?php echo $row['male_count']; ?></td>
                                            <td><?php echo $row['female_count']; ?></td>
                                            <td><?php echo $row['male_count'] + $row['female_count']; ?></td>
                                        </tr>
                                ...
                                <tfoot class="table-info">
                                    <tr>
                                        ...
                                        <td><?php echo $shs11Totals['total_male']; ?></td>
                                        <td><?php echo $shs11Totals['total_female']; ?></td>
                                        <td><?php echo $shs11Totals['total']; ?></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php 
                                    $shs12Data = array_filter($shsData, function($row) {
                                        return $row['grade_level'] === 'Grade 12';
                                    });
                                    foreach ($shs12Data as $row): 
                                    ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($row['strand'] . ' - ' . $row['section']); ?></td>
                                            <td><?php echo $row['male_count']; ?></td>
                                ...
                                <tfoot class="table-success">
                                    <tr>
                                        <td><strong>Total</strong></td>
                                        <td><?php echo $shs12Totals['total_male']; ?></td>
                                        <td><?php echo $shs12Totals['total_female']; ?></td>
                                        <td><?php echo $shs12Totals['total']; ?></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
    ...
    <script>
        ...
        new Chart(document.getElementById('overallChart').getContext('2d'), {
            type: 'pie',
            data: {
                labels: ['JHS', 'SHS Grade 11', 'SHS Grade 12'],
                datasets: [{
                    data: [
                        <?php echo $jhsTotals['total']; ?>, 
                        <?php echo $shs11Totals['total']; ?>, 
                        <?php echo $shs12Totals['total']; ?>
                    ],
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Student Population Distribution',
                        font: {
                            size: 18,
                            weight: 'bold'
                        },
                ...
                animation: {
                    ...
                    onComplete: function() {
                        // Add a second animation after the first one completes
                        const ctx = this.chart.ctx;
                        ctx.save();
                        ctx.globalAlpha = 0.5;
                        ctx.beginPath();
                        ctx.arc(this.chart.width / 2, this.chart.height / 2, this.chart.radius * 1.1, 0, 2 * Math.PI);
        ...
        // Overall Population Bar Chart
        new Chart(document.getElementById('overallBarChart').getContext('2d'), {
            type: 'bar',
            data: {
                labels: ['JHS', 'SHS Grade 11', 'SHS Grade 12'],
                datasets: [{
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Student Population by Level',
                        font: {
                            size: 18,
                            weight: 'bold'
                        },
        ...
        // SHS Chart
        new Chart(document.getElementById('shsChart').getContext('2d'), {
            type: 'bar',
            data: {
                labels: ['STEM G11', 'ABM G11', 'HUMSS G11', 'HE G11', 'ICT G11', 'STEM G12', 'ABM G12', 'HUMSS G12', 'ICT G12', 'HE G12'],
                datasets: [{
                    label: 'Male',
                    data: [88, 12, 71, 15, 41, 69, 11, 78, 34, 18],
                    backgroundColor: '#4e73df'
                }, {
                    label: 'Female',
                    data: [79, 56, 74, 13, 19, 68, 48, 65, 11, 32],
                    backgroundColor: '#1cc88a'
                }]
            },
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'SHS Population by Strand and Gender',
                        font: {
                            size: 16
                        }
                    }
