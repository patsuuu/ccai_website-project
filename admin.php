        ...
        <div class="admin-nav">
            <div class="dropdown">
                <button class="admin-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <span class="admin-text"><?php echo htmlspecialchars($admin_username); ?></span>
                </button>
...
<main>
    <div class="container mt-4">
        ...
        <center>  <h2 class="headshake-title d-inline-block">Super Admin Dashboard</h2></center><br><br>
        ...
        <div class="row justify-content-center g-4">
            <div class="col-md-6 col-lg-4">
                <div class="card-container">
                    ...
                    <button onclick="window.location.href='admin/add_news.php'" class="float-button">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-container">
                    ...
                    <button onclick="window.location.href='uploadform.php'" class="float-button">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-container">
                    ...
                    <button onclick="window.location.href='popul.php'" class="float-button">
                        <i class="fa fa-user-plus"></i>Add Population
                    </button>
                </div>
            </div>

            <!-- Add this card after the existing cards -->
            <div class="col-md-6 col-lg-4">
                <div class="card-container">
                    <div class="card h-100" style="background-color: #DEE7E7;">
                        <div class="card-body text-center">
                            <i class="fa fa-user-plus fa-3x mb-3" style="color: #000080;"></i>
                            <h5 class="card-title">Admin Accounts</h5>
                            <p class="card-text">Manage admin accounts.</p>
                        </div>
                    </div>
                    <button onclick="window.location.href='admin/create_admin.php'" class="float-button">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-container">
                    ...
                    <button onclick="window.location.href='upload_event.php'" class="float-button">
                        <i class="fa fa-plus"></i>Add Events
                    </button>
                </div>
            </div>

            <!-- Add Video Management System Card -->
            <div class="col-md-6 col-lg-4">
                <div class="card-container">
                    <div class="card h-100" style="background-color: #DEE7E7;">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Upload, manage and delete videos.</p>
                        </div>
                    </div>
                    <button onclick="window.location.href='upload_video.php'" class="float-button">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-container">
                    ...
                    <button onclick="window.location.href='org_manage.php'" class="float-button">
